...
# Build environment
grub_target_cc='gcc'
grub_target_cc_version='gcc (Alpine 12.2.1_git20220924-r4) 12.2.1 20220924'
...
grub_target_cppflags=' -Wall -W  -DGRUB_MACHINE_EFI=1 -DGRUB_MACHINE=X86_64_EFI -m64 -nostdinc -isystem /usr/lib/gcc/x86_64-alpine-linux-musl/12.2.1/include -I$(top_srcdir)/include -I$(top_builddir)/include'
...
grub_cflags='-Os -fomit-frame-pointer'
grub_cppflags='-Os -fomit-frame-pointer -D_FILE_OFFSET_BITS=64'
grub_ccasflags='-Os -fomit-frame-pointer'
grub_ldflags='-Wl,--as-needed,-O1,--sort-common'
